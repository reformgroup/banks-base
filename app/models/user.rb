...
class User < ActiveRecord::Base
  ...
  #
  #  User.create(first_name: "Nikolay", last_name: "Lipovtsev", email: "test@mail.com", birth_date: 18.years.ago - Faker::Number.number(3).to_i.days, gender: :male, password: "123123", password_confirmation: "123123", role: "admin")
  #
